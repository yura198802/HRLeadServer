...
namespace Monica.Core.DbModel.Migrations
{
    ...
    [Migration("20201127194112_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monica.Core.DbModel.ModelCrm.HR.CategoryVacancy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Monica.Core.DbModel.ModelCrm.HR.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Monica.Core.DbModel.ModelCrm.HR.Requirement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Monica.Core.DbModel.ModelCrm.HR.Vacancy", b =>
                {
                    ...
                    b.Property<int?>("CategoryVacancyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Monica.Core.DbModel.ModelCrm.HR.Work", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Monica.Core.DbModel.ModelCrm.HR.Vacancy", b =>
                {
                    b.HasOne("Monica.Core.DbModel.ModelCrm.HR.CategoryVacancy", "CategoryVacancy")
                        .WithMany("Vacancies")
                        .HasForeignKey("CategoryVacancyId");
                });
